...
In order to support loading of multiple wallets in bitchcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to bitchcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into bitchcoin-qt, and as such, will require some minor modifications to provide hooks for
