UNIX BUILD NOTES
====================
Some notes on how to build Envycoin in Unix. 
...
This will build envycoin-qt as well if the dependencies are met.
...
If you want to build Envycoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a envycoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip envycoind" to strip the debug
