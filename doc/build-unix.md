UNIX BUILD NOTES
====================
Some notes on how to build Bitchcoin in Unix. 
...
This will build bitchcoin-qt as well if the dependencies are met.
...
If you want to build Bitchcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bitchcoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip bitchcoind" to strip the debug
