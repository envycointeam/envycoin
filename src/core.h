...
static const int64_t MAX_MONEY = 100000 * COIN; // Envycoin: maximum of 100K coins, max transaction 100K
...
public:
    ...
    {
        // Envycoin: IsDust() detection disabled, allows any valid dust to be relayed.
